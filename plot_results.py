...
for i_env, env_name in tqdm(enumerate(env_names), total=len(env_names)):
    ...
    things = [("reconstruction/reconstruction_nextstate_ppo_modelclip_logs3/" + env_name + "/", "Reconstruction"), ("reconstruction/nextstate_reward_ppo_modelclip_logs2/" + env_name + "/", "Reward")]
#     ax = axes
