...
source ~/miniconda3/bin/activate && conda activate auto-drac && python train.py --env_name ${env_name} --log_dir separate_optimizers_modelbased_logs/${env_name}/${env_name}-${trial}-${num_mini_batch} --aug_coef 0.
