...
source ~/miniconda3/bin/activate && conda activate auto-drac && python train.py --env_name ${env_name} --log_dir pretraining/vanilla_ppo_switch1/${env_name}/${env_name}-${trial} --aug_coef 0.
